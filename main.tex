...
\medskip\noindent\emph{Game 10:} When $P$'s session begins, halt after checking if $H_2(\pw,T)$ has been defined (i.e., before the {\color{brown} brown} text in Game 9). Then when $P$ receives $(c^*,\tau^*)$,
\begin{itemize}
